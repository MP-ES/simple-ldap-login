				...
				<tbody>
					<tr>
						...
						<td>
							...
							<label><input type="checkbox" name="<?php echo esc_attr( $this->get_field_name( 'enabled' ) ); ?>" value="true" 
																		   <?php
					...
					<tr>
						...
						<td>
							<input type="text" name="<?php echo esc_attr( $this->get_field_name( 'account_suffix' ) ); ?>" value="<?php echo esc_attr( htmlspecialchars( $simple_ldap_login->get_setting( 'account_suffix' ) ) ); ?>" /><br/>
					...
					<tr>
						...
						<td>
							<input type="text" name="<?php echo esc_attr( $this->get_field_name( 'base_dn' ) ); ?>" value="<?php echo esc_attr( $simple_ldap_login->get_setting( 'base_dn' ) ); ?>" />
							<br/>
					...
					<tr>
						...
						<td>
							<input type="text" name="<?php echo esc_attr( $this->get_field_name( 'domain_controllers', 'array' ) ); ?>" value="<?php echo esc_attr( join( ';', (array) $simple_ldap_login->get_setting( 'domain_controllers' ) ) ); ?>" />
					...
					<tr>
						...
						<td>
							<label><input type="radio" name="<?php echo esc_attr( $this->get_field_name( 'directory' ) ); ?>" value="ad" 
																		<?php
																		if ( $this->get_setting( 'directory' ) == 'ad' ) {
																			echo "checked='checked'";}
																		?>
							 /> Active Directory</label><br/>
							<label><input type="radio" name="<?php echo esc_attr( $this->get_field_name( 'directory' ) ); ?>" value="ol" 
																		<?php
																		if ( $this->get_setting( 'directory' ) == 'ol' ) {
																			echo "checked='checked'";}
																		?>
			...
			<table class="form-table" style="margin-bottom: 20px;">
				<tbody>
					<tr>
						...
						<td>
							<input type="text" name="<?php echo esc_attr( $this->get_field_name( 'groups', 'array' ) ); ?>" value="<?php echo esc_attr( join( ';', (array) $simple_ldap_login->get_setting( 'groups' ) ) ); ?>" /><br/>
					...
					<tr>
						...
						<td>
							...
							<label><input type="checkbox" name="<?php echo esc_attr( $this->get_field_name( 'high_security' ) ); ?>" value="true" 
																		   <?php
					...
					<tr>
						...
						<td>
							...
							<label><input type="checkbox" name="<?php echo esc_attr( $this->get_field_name( 'create_users' ) ); ?>" value="true" 
																		   <?php
			...
			<table class="form-table">
				<tbody>
					<tr>
						...
						<td>
							<input type="text" name="<?php echo esc_attr( $this->get_field_name( 'group_base_dn' ) ); ?>" value="<?php echo esc_attr( $simple_ldap_login->get_setting( 'group_base_dn' ) ); ?>" />
							<br/>
					...
					<tr>
						...
						<td>
							<input type="text" name="<?php echo esc_attr( $this->get_field_name( 'ol_login' ) ); ?>" value="<?php echo esc_attr( $simple_ldap_login->get_setting( 'ol_login' ) ); ?>" />
							<br />
							Default: <b>uid</b>;
						</td>
					</tr>
					<tr>
						...
						<td>
							<input type="text" name="<?php echo esc_attr( $this->get_field_name( 'ol_group' ) ); ?>" value="<?php echo esc_attr( $simple_ldap_login->get_setting( 'ol_group' ) ); ?>" />
							<br />
					...
					<tr>
						...
						<td>
							...
							<label><input type="checkbox" name="<?php echo esc_attr( $this->get_field_name( 'use_tls' ) ); ?>" value="true" 
																		   <?php
					...
					<tr>
						...
						<td>
							<input type="text" name="<?php echo esc_attr( $this->get_field_name( 'ldap_port' ) ); ?>" value="<?php echo esc_attr( $simple_ldap_login->get_setting( 'ldap_port' ) ); ?>" /><br/>
							This is usually 389.
						</td>
					</tr>
					<tr>
						...
						<td>
							<input type="text" name="<?php echo esc_attr( $this->get_field_name( 'ldap_version' ) ); ?>" value="<?php echo esc_attr( $simple_ldap_login->get_setting( 'ldap_version' ) ); ?>" /><br/>
					...
					<tr>
						...
						<td>
							...
							<label><input type="checkbox" name="<?php echo esc_attr( $this->get_field_name( 'search_sub_ous' ) ); ?>" value="true" 
																		   <?php
					...
					<tr>
						...
						<td>
							<input type="text" name="<?php echo esc_attr( $this->get_field_name( 'login_domain' ) ); ?>" value="<?php echo esc_attr( $simple_ldap_login->get_setting( 'login_domain' ) ); ?>" /><br/>
				...
				<tbody>
					...
					<tr>
						...
						<td>
							...
							<label><input type="checkbox" name="<?php echo esc_attr( $this->get_field_name( 'sso_enabled' ) ); ?>" value="true" 
																		   <?php
					...
					<tr>
						...
						<td>
							<input type="text" name="<?php echo esc_attr( $this->get_field_name( 'sso_search_user' ) ); ?>" value="<?php echo esc_attr( $simple_ldap_login->get_setting( 'sso_search_user' ) ); ?>" />
							<br/>
			...
			<table class="form-table" style="margin-bottom: 20px;">
				<tbody>
					<tr>
						...
						<td>
							<input type="text" name="<?php echo esc_attr( $this->get_field_name( 'user_first_name_attribute' ) ); ?>" value="<?php echo esc_attr( $simple_ldap_login->get_setting( 'user_first_name_attribute' ) ); ?>" />
							<br/>
					...
					<tr>
						...
						<td>
							<input type="text" name="<?php echo esc_attr( $this->get_field_name( 'user_last_name_attribute' ) ); ?>" value="<?php echo esc_attr( $simple_ldap_login->get_setting( 'user_last_name_attribute' ) ); ?>" />
							<br/>
					...
					<tr>
						...
						<td>
							<input type="text" name="<?php echo esc_attr( $this->get_field_name( 'user_email_attribute' ) ); ?>" value="<?php echo esc_attr( $simple_ldap_login->get_setting( 'user_email_attribute' ) ); ?>" />
							<br/>
					...
					<tr>
						...
						<td>
							<input type="text" name="<?php echo esc_attr( $this->get_field_name( 'user_url_attribute' ) ); ?>" value="<?php echo esc_attr( $simple_ldap_login->get_setting( 'user_url_attribute' ) ); ?>" />
							<br/>
			...
			<table class="form-table" style="margin-bottom: 20px;">
				<tbody>
					<tr>
						...
						<td>
							<textarea cols="50" name="<?php echo esc_attr( $this->get_field_name( 'user_meta_data' ) ); ?>">
																 <?php
																	echo esc_html(
																		join(
																			"\n",
					...
					<tr>
						...
						<td>
							<input type="text" name="<?php echo esc_attr( $this->get_field_name( 'meta_data_suffix_ldap' ) ); ?>" value="<?php echo esc_attr( $simple_ldap_login->get_setting( 'meta_data_suffix_ldap' ) ); ?>" />
							<br/>
					...
					<tr>
						...
						<td>
							<input type="text" name="<?php echo esc_attr( $this->get_field_name( 'meta_data_suffix_wp' ) ); ?>" value="<?php echo esc_attr( $simple_ldap_login->get_setting( 'meta_data_suffix_wp' ) ); ?>" />
							<br/>
